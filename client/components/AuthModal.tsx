  ...
  const handleSocialAuth = async (provider: string) => {
    if (provider === 'discord') {
      try {
        ...
        toast({
          title: "Discord Giriş Hatası",
          description: "Discord ile giriş yapılırken bir hata oluştu",
          variant: "destructive",
        });
      }
    } else {
      ...
      <DialogContent className="sm:max-w-md bg-anime-card border-white/10 text-white">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Button
            ...
            className="bg-indigo-600/20 border-indigo-500/50 text-indigo-300 hover:bg-indigo-600/30 hover:border-indigo-400"
          >
          ...
          <Button
            ...
            className="bg-gray-600/20 border-gray-500/50 text-gray-300 hover:bg-gray-600/30 hover:border-gray-400"
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
