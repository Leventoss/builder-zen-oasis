...
export default function ChatEnhanced() {
  ...
  const categoryGreetings = {
    ...
    premium:
      "Merhaba! Premium üyelik ve özel destek için sorularınızı bekliyorum. Size özel yardım sağlayabilirim.",
    "oncelik-destek":
      "Merhaba! Premium üyemizsiniz, bu yüzden öncelikli destek hattındasınız. Size hızlı çözüm sağlayacağım.",
  };
  ...
  const categoryTips = {
    ...
    "oncelik-destek":
      "İpucu: Premium üye olarak 7/24 öncelikli destek alıyorsunuz.",
  };
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-anime-card border border-anime-accent/20 p-6 rounded-lg">
              ...
              <Button
                ...
                disabled={
                  !selectedCategory ||
                  !canAccessPremiumCategory(selectedCategory)
                }
            ...
            {isPremium && (
              <Alert className="mt-3 border-yellow-600/40 bg-yellow-600/10">
                ...
                <AlertDescription className="text-yellow-200">
                  Premium üye olarak öncelikli destek alıyorsunuz. Yanıtlarımız
                  daha hızlı ve detaylı olacaktır.
                </AlertDescription>
              </Alert>
            )}
          </div>
